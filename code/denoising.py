...
def denoising(identifier: str, data: Optional[Union[str, DataDescriptor]] = None, lr=0.001, depth=4, wf=7, n_input=4, noise_std=0.2, noise_res=16, gaussian_noise=True):
    ...
    Loss(lambda batch_res, batch: loss_f(trainer, batch, batch_res)).register(trainer.callback_dict, log=True, tensorboard=True, train=True, val=True)
